...
import { allpost, allusers, allvideos, getusers } from '../constants/Constants'
import { useEffect } from 'react'
import axios from '../axios'

function UserAnalystics() {
    ...
    function getvideos(){
        axios.get(allvideos).then((response)=>{
        ...
        <>
            <div class="md:col-span-2 lg:col-span-1" >
                <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Total Users</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700">{totaluser.length}</h3>
                        </div>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 class="text-xl text-gray-700">Photo Uploaded</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-bold text-gray-800">{post.length} Posts</h1>
                        <span class="text-gray-500">Uploaded by Users</span>
                    </div>
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="mt-6">
                        <h5 class="text-xl text-gray-700 text-center">VIDEOS UPLOADED</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700">{videos.length}</h3>
