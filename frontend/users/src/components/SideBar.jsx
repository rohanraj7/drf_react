...
function SideBar(){
    ...
    return(
        ...
        <div className="px-4" >
        <div className='flex' >
                <img className='' src="../../512.png" style={{ height: '40px',marginRight: '10px' }}  />
                <h2 className="mt-3 mb-3 text-sm font-medium text-blue-400 ">ConnectOuts</h2>
            </div>
                ...
                <Link to='/profile/saved' className={pathname === '/saved' ? activeElementClasses : nonActiveElementClasses}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
